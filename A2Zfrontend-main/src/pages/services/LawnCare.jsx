...
// FIX 1 ▸ Added LocalBusiness schema (was missing — landscape page had it, this page didn't)
const SCHEMA_LOCAL_BUSINESS = JSON.stringify({
  "@context": "https://schema.org",
  "@type": "LocalBusiness",
  "name": "A to Z Landscaping & More",
  "description": "Professional lawn care and maintenance in Kitsap County, WA. Mowing, fertilization, weed control, moss removal, overseeding, lawn renovation, sod and topsoil installation.",
  "url": "https://atozlandscapingandmore.com/services/lawn-care",
  "telephone": "+13609533878",
  "areaServed": "Kitsap County, WA",
  "founder": { "@type": "Person", "name": "Ryan Scott Sant" },
  "hasOfferCatalog": {
    "@type": "OfferCatalog",
    "name": "Lawn Care & Maintenance Services",
    "itemListElement": [
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Mow & Maintain",                     "url": "https://atozlandscapingandmore.com/lawn-care/mow-and-maintain/" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Raking",                             "url": "https://atozlandscapingandmore.com/lawn-care/raking/" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Fertilization",                      "url": "https://atozlandscapingandmore.com/lawn-care/fertilization/" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Weed Control",                       "url": "https://atozlandscapingandmore.com/lawn-care/weed-control/" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Moss Removal",                       "url": "https://atozlandscapingandmore.com/lawn-care/moss-removal/" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Thatching",                          "url": "https://atozlandscapingandmore.com/lawn-care/thatching/" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Overseeding",                        "url": "https://atozlandscapingandmore.com/lawn-care/overseeding/" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "New Lawn Installation",              "url": "https://atozlandscapingandmore.com/lawn-care/new-lawn-installation/" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Lawn Renovation & Rebeautification", "url": "https://atozlandscapingandmore.com/lawn-care/lawn-renovation/" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Sod & Topsoil",                      "url": "https://atozlandscapingandmore.com/lawn-care/sod-topsoil/" } }
    ]
  }
});

// FIX 1 ▸ Added FAQPage schema — enables Google rich result FAQ snippets in SERPs
const SCHEMA_FAQ = JSON.stringify({
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How Often Should a Lawn Be Mowed in Kitsap County?",
      "acceptedAnswer": { "@type": "Answer", "text": "Most Kitsap County lawns need mowing every 7–10 days from April through October and every 3–4 weeks in winter. Frequency depends on grass type, fertilization rate, and current rainfall." }
    },
    {
      "@type": "Question",
      "name": "When Is the Best Time to Overseed a Lawn in Kitsap County?",
      "acceptedAnswer": { "@type": "Answer", "text": "Early fall is the best window. Soil is still warm enough for germination, fall rainfall reduces irrigation needs, and grass establishes before winter. Early spring is the second-best option." }
    },
    {
      "@type": "Question",
      "name": "What Causes Moss and How Do I Stop It from Coming Back?",
      "acceptedAnswer": { "@type": "Answer", "text": "Moss grows where drainage is poor, soil pH is low, shade is heavy, or turf density is thin. Killing moss without correcting the underlying condition means it returns within one season." }
    },
    {
      "@type": "Question",
      "name": "Does My Lawn Need to Be Thatched Every Year?",
      "acceptedAnswer": { "@type": "Answer", "text": "Most lawns don't need annual thatching. Measure the thatch layer first — under a half-inch, skip it. Thatching too frequently removes beneficial organic material and stresses the root zone." }
    },
    {
      "@type": "Question",
      "name": "What's the Difference Between Lawn Renovation and New Lawn Installation?",
      "acceptedAnswer": { "@type": "Answer", "text": "Renovation improves an existing lawn through overseeding, moss treatment, and soil amendment without removing the turf. Installation starts from bare soil. Renovation is the right call when at least half the lawn still has healthy grass." }
    }
  ]
});

// ─── Component ───────────────────────────────────────────────────────────────
// FIX 2 ▸ Removed duplicate useEffect that was double-writing <title> and
//          <meta description> alongside Helmet — Helmet is the single source of truth.
export default function LawnCareServicePage() {
  ...
  return (
    <>
      <Helmet>
        <title>Lawn Care &amp; Maintenance Services | Kitsap County WA | A to Z Landscaping</title>
        ...
        <link rel="canonical" href="https://atozlandscapingandmore.com/services/lawn-care" />

        {/* Open Graph */}
        <meta property="og:title"       content="Lawn Care & Maintenance Services | A to Z Landscaping" />
        <meta property="og:description" content="Professional lawn care services throughout Kitsap County." />
        <meta property="og:type"        content="website" />
        <meta property="og:url"         content="https://atozlandscapingandmore.com/lawn-care/" />
        <meta property="og:image"       content="https://atozlandscapingandmore.com/images/lawn-care.jpg" />

        {/* FIX 3 ▸ Twitter/X card meta tags added */}
        <meta name="twitter:card"        content="summary_large_image" />
        <meta name="twitter:title"       content="Lawn Care & Maintenance Services | A to Z Landscaping" />
        <meta name="twitter:description" content="Professional lawn care services throughout Kitsap County." />
        <meta name="twitter:image"       content="https://atozlandscapingandmore.com/images/lawn-care.jpg" />

        {/* FIX 1 ▸ LocalBusiness JSON-LD */}
        <script type="application/ld+json">{SCHEMA_LOCAL_BUSINESS}</script>

        {/* FIX 1 ▸ FAQPage JSON-LD — enables Google rich result FAQ snippets */}
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-amber {
          ...
          font-family: 'Spartan', sans-serif; text-decoration: none;
        }
        ...
        .lp-stat-num   { display: block; font-family: 'Gothic', sans-serif; font-size: 2.4rem; font-weight: 800; color: #fff; line-height: 1; }
        .lp-stat-label { display: block; font-family: 'Spartan', sans-serif; font-size: .69rem; font-weight: 700; letter-spacing: .11em; text-transform: uppercase; color: rgba(255,255,255,.74); margin-top: 3px; }

        /* ── SHARED ───────────────────────────────────────────────── */
        .lp-inner { max-width: 1100px; margin: 0 auto; }
        .lp-tag   { font-family: 'Spartan', sans-serif; font-size: .67rem; font-weight: 700; letter-spacing: .2em; text-transform: uppercase; color: #C4883A; margin-bottom: .6rem; display: block; }
        .lp-h2    { font-family: 'Gothic', sans-serif; font-size: clamp(1.7rem, 3.6vw, 2.5rem); font-weight: 700; color: #162619; line-height: 1.2; margin-bottom: .8rem; }
        .lp-lead  { font-family: 'Spartan', sans-serif; color: #576858; font-size: 1.02rem; max-width: 630px; line-height: 1.78; margin-bottom: 2.8rem; }
        ...
        .lp-card-name { font-family: 'Gothic', sans-serif; font-size: 2rem; font-weight: 700; color: #162619; margin-bottom: .5rem; line-height: 1.25; }
        .lp-card-desc { font-family: 'Spartan', sans-serif; font-size: .86rem; color: #576858; line-height: 1.65; }
        /* FIX 4 ▸ "Learn More" changed from <button> to <a> so Google can crawl each service URL */
        .lp-card-link {
          display: inline-flex; align-items: center; gap: 4px; margin-top: .85rem;
          font-family: 'Spartan', sans-serif;
          font-size: .72rem; font-weight: 700; color: #C4883A;
        ...
        .lp-pnum  { position: absolute; top: -6px; right: 12px; font-family: 'Gothic', sans-serif; font-size: 5.2rem; font-weight: 800; color: rgba(196,136,58,.11); line-height: 1; pointer-events: none; user-select: none; }
        .lp-ptitle { font-family: 'Gothic', sans-serif; font-size: 2rem; font-weight: 700; color: #fff; margin-bottom: .82rem; line-height: 1.27; padding-right: 2.2rem; }
        .lp-pbody  { font-family: 'Spartan', sans-serif; font-size: .86rem; color: rgba(255,255,255,.59); line-height: 1.72; }
        ...
        .lp-step-dot   { width: 3.7rem; height: 3.7rem; background: #fff; border: 2px solid #C4883A; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto .9rem; font-family: 'Gothic', sans-serif; font-size: .92rem; font-weight: 700; color: #C4883A; }
        .lp-step-title { font-family: 'Gothic', sans-serif; font-size: 1.5rem; font-weight: 700; color: #162619; margin-bottom: .35rem; }
        /* FIX 5 ▸ lp-step-body was 1.5rem (bug) — corrected to .82rem to match design system */
        .lp-step-body  { font-family: 'Spartan', sans-serif; font-size: .82rem; color: #576858; line-height: 1.55; }
        ...
        .lp-trust-item { display: flex; align-items: flex-start; gap: .7rem; font-family: 'Spartan', sans-serif; font-size: .91rem; color: #354437; line-height: 1.5; }
        ...
        .lp-badge-num { display: block; font-family: 'Gothic', sans-serif; font-size: 1.85rem; font-weight: 800; line-height: 1; }
        .lp-badge-lbl { display: block; font-family: 'Spartan', sans-serif; font-size: .66rem; font-weight: 700; letter-spacing: .08em; text-transform: uppercase; opacity: .85; margin-top: 2px; }
        ...
        .lp-faq-btn  { width: 100%; background: #fff; border: none; padding: 1.3rem 1.65rem; display: flex; align-items: center; justify-content: space-between; gap: .9rem; text-align: left; cursor: pointer; transition: background .15s; font-family: 'Spartan', sans-serif; }
        .lp-faq-btn:hover, .lp-faq-btn.open { background: #F2F6F2; }
        .lp-faq-q    { font-family: 'Gothic', sans-serif; font-size: 1.5rem; font-weight: 600; color: #162619; line-height: 1.4; margin: 0; }
        .lp-faq-icon { flex-shrink: 0; color: #C4883A; }
        .lp-faq-ans  { background: #F2F6F2; padding: 0 1.65rem 1.3rem; font-family: 'Spartan', sans-serif; font-size: .91rem; color: #576858; line-height: 1.78; }

        /* ── CTA ──────────────────────────────────────────────────── */
        .lp-cta-bg  { background: linear-gradient(138deg, #162619 0%, #2A5038 100%); padding: 5.5rem 2rem; text-align: center; }
        .lp-cta-h2  { font-family: 'Gothic', sans-serif; font-size: clamp(1.7rem, 3.6vw, 2.5rem); font-weight: 700; color: #fff; line-height: 1.2; max-width: 560px; margin: 0 auto .8rem; }
        .lp-cta-sub { font-family: 'Spartan', sans-serif; color: rgba(255,255,255,.62); font-size: 1rem; margin-bottom: 2.2rem; max-width: 420px; margin-left: auto; margin-right: auto; }
        .lp-cta-note { font-family: 'Spartan', sans-serif; margin-top: 1.25rem; font-size: .76rem; color: rgba(255,255,255,.36); letter-spacing: .04em; }
      ...
      <main className="lp">
        ...
        <section className="lp-hero" aria-label="Page hero">
          {/*
            FIX 6 ▸ loading="eager" on LCP hero image (above-the-fold, should load immediately).
                     lazy is correct for below-fold images only.
          */}
          <img
            className="lp-hero-photo"
            src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=1400&q=80"
            alt="Professional lawn care in Kitsap County WA"
            loading="eager"
            fetchPriority="high"
          />
          ...
          <div className="lp-hero-inner">
            ...
            <div className="lp-cta-row">
              {/* FIX 4 (hero) ▸ Wrapped in <a href="tel:"> so it's a real crawlable link */}
        ...
        {/* ── STATS ── */}
        <div className="lp-stats" aria-label="Business statistics">
        ...
        <section className="lp-svc-bg" aria-labelledby="svc-h">
          <div className="lp-inner">
            ...
            <div className="lp-svc-grid">
              {SERVICES.map(({ IconKey, name, desc, href }, i) => {
                ...
                return (
                  <article className="lp-card" key={i}>
                    ...
                    {/*
                      FIX 4 ▸ Was <button> — Google couldn't crawl service URLs.
                               Now a real <a href> using each card's existing href value.
                    */}
                    <a href={href} className="lp-card-link" aria-label={`Learn more about ${name}`}>
                      Learn More →
                    </a>
                  </article>
                );
        ...
        <section className="lp-trust-bg" aria-labelledby="trust-h">
          <div className="lp-trust-grid">
            ...
            <div className="lp-imgbox">
              {/* FIX 6 ▸ loading="lazy" added — below-the-fold image, defers load correctly */}
              <img
                src="https://images.unsplash.com/photo-1416879595882-3373a0480b5b?auto=format&fit=crop&w=800&q=80"
                alt="Kitsap County lawn maintained by A to Z Landscaping"
                loading="lazy"
              />
          ...
          <div className="lp-faq-wrap">
            {FAQS.map((f, i) => (
              <div className="lp-faq-item" key={i}>
                <button
                  className={`lp-faq-btn${openFaq === i ? " open" : ""}`}
                  onClick={() => toggleFaq(i)}
                ...
                {openFaq === i && (
                  <div className="lp-faq-ans" id={`faq-ans-${i}`} role="region">
                    {f.a}
                  </div>
                )}
              </div>
        ...
        <section className="lp-cta-bg" aria-label="Call to action">
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            {/*
              FIX 4 (CTA) ▸ Was onClick → window.location.href — not crawlable.
                             Now a proper <a href="tel:"> anchor, same pattern as hero.
            */}
