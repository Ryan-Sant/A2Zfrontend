...
// ─── Data ─────────────────────────────────────────────────────────────────────
const SERVICES = [
  { Icon: ScissorsIcon, name: "Bush & Shrub Trimming",           desc: "Shrubs can frame a home, soften hard edges, and provide privacy. Once too dense or uneven, they block light, narrow walkways, cover windows, and make beds look neglected. We restore a suitable size and shape while respecting natural growth clearance, balance, nearby plants, and the role each shrub plays in the larger design.", href: "/services/landscape-design" },
  { Icon: TreeIcon,     name: "Tree Trimming & Branch Removal",  desc: "Low, damaged, or intrusive branches can interfere with paths, views, rooflines, and other plantings. Selective trimming and branch removal opens crowded areas and helps the rest of the landscape read more clearly. The scope depends on the tree, branch location, access, and surrounding property.", href: "/services/landscape-design" },
  { Icon: LayersIcon,   name: "Mulch & Bark Dust",               desc: "Mulch and bark dust give planting beds a defined finish while helping cover exposed soil. Material choice, depth, bed preparation, and edge condition all affect the final appearance. We prepare the area first fresh material is not a way to hide weeds, debris, or poor bed shape.", href: "/services/landscape-design" },
];
...
const SCHEMA_LOCAL_BUSINESS = JSON.stringify({
  ...
  "description": "Professional landscaping and design services in Kitsap County, WA. Bush trimming, tree branch removal, mulch, bed work, and full backyard design.",
  "url": "https://atozlandscapingandmore.com/services/landscape-design",
  ...
  "hasOfferCatalog": {
    ...
    "itemListElement": [
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Bush & Shrub Trimming",          "url": "https://atozlandscapingandmore.com/services/landscape-design" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Tree Trimming & Branch Removal", "url": "https://atozlandscapingandmore.com/services/landscape-design" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Mulch & Bark Dust",              "url": "https://atozlandscapingandmore.com/services/landscape-design" } }
    ]
  }
});
...
const SCHEMA_FAQ = JSON.stringify({
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "What Does a Landscape Designer Do?",                      "acceptedAnswer": { "@type": "Answer", "text": "A landscape designer plans how plants, lawn, beds, paths, and open areas work together based on your goals, property conditions, appearance preferences, and maintenance expectations." } },
    { "@type": "Question", "name": "What Do Landscape Design Services Include?",               "acceptedAnswer": { "@type": "Answer", "text": "Landscape design services may include site review, layout planning, plant and bed decisions, trimming priorities, material choices, and a practical sequence for completing the work." } },
    { "@type": "Question", "name": "What Is Included in Residential Landscape Design?",        "acceptedAnswer": { "@type": "Answer", "text": "Residential landscape design organizes planting, open space, privacy, access, views, and maintenance around how your household uses the property each day and wants it to feel." } },
    { "@type": "Question", "name": "Can You Handle Landscape Design and Installation?",        "acceptedAnswer": { "@type": "Answer", "text": "Yes. A to Z Landscaping and More connects landscape design and installation, allowing the approved direction to guide trimming, bed work, material placement, and related improvements." } },
    { "@type": "Question", "name": "How Should I Prepare for a Backyard Design Consultation?", "acceptedAnswer": { "@type": "Answer", "text": "Think about how you use the yard, what bothers you, what should remain, and which results matter most. Photos and inspiration help, but are not required." } }
  ]
});
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="twitter:title"       content="Landscaping & Design Services | A to Z Landscaping" />
        <meta name="twitter:description" content="Professional landscaping and design in Kitsap County, WA. Free estimates." />
        <meta name="twitter:image"       content="https://atozlandscapingandmore.com/landscape-design.jpg" />
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* FIX ▸ line-height was 4.1rem (bug) — corrected to 1.2 */
        ...
        .ld-step-title { font-family: 'Gothic', sans-serif; font-size: 1.2rem; font-weight: 700; color: #162619; margin-bottom: .35rem; }
        ...
        /* FIX ▸ Was clamp(1.rem, 3.6vw, rem) — invalid CSS — fixed to valid values */
        .ld-cta-h2   { font-family: 'Gothic', sans-serif; font-size: clamp(1.7rem, 3.6vw, 2.5rem); font-weight: 700; color: #fff; line-height: 1.2; max-width: 580px; margin: 0 auto .8rem; }
      ...
      <main className="ld">
        ...
        <section className="ld-hero" aria-label="Page hero">
          {/* FIX ▸ loading="eager" + fetchPriority="high" on LCP hero image */}
          ...
          <div className="ld-hero-inner">
            ...
            <div className="ld-cta-row">
              {/* FIX ▸ Proper tel: anchor with no spaces */}
          ...
          <div className="ld-inner ld-about-grid">
            <div>
              ...
              <div className="ld-about-body">
                <p>I'm Ryan Scott Sant, the owner behind A to Z Landscaping and More. I bring nine years of landscaping experience to the work, and the company has completed 1,300 projects in Kitsap County. That experience has shown me how quickly a property becomes harder to manage when work is done out of order. Trimming too soon or adding material before reshaping a bed can limit the final result.</p>
                <p>I start by listening to what is bothering you and what you want the property to do better. From there, I help shape a practical scope that fits the space. When a crew is involved, we carry out the agreed work as a company, with the design direction guiding each step.</p>
              </div>
            </div>
            <div className="ld-about-img">
              {/* FIX ▸ loading="lazy" on below-fold image */}
              <img src={image7}
            ...
            <div className="ld-svc-grid">
              {SERVICES.map(({ Icon, name, desc, href }, i) => (
                <article className="ld-card" key={i}>
                  ...
                  {/* FIX ▸ Real <a href> instead of bare text — crawlable by Google */}
          ...
          <div className="ld-faq-wrap">
            {FAQS.map((f, i) => (
              <div className="ld-faq-item" key={i}>
                {/* FIX ▸ aria-controls + id on answer for full accessibility */}
                <button
        ...
        <section className="ld-cta-bg" aria-label="Call to action">
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            {/* FIX ▸ onClick → window.location replaced with proper crawlable tel: anchor */}
