...
const TRUST_ITEMS = [
  "Ryan answers your call, gives the quote, and oversees the work directly — every time",
  "Clean site at the end of every job — no debris left behind for you to deal with",
  "Most new clients come from referrals — that only happens when the work holds up",
  "From tight urban backyards to five-acre rural lots — the range is what makes a crew useful",
];
    ...
    <>
      ...
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .ab-std-title{font-family:'Gothic',sans-serif;font-size:1.2rem;font-weight:700;color:var(--white);margin-bottom:.85rem;padding-right:2rem;}
